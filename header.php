...
<body>
    ...
    <div class="preloader-wrapper">
        <div class="preloader">
            <img src="assets//spin.gif" alt="NILA">
        </div>
    </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
                ...
                if(isset($_SESSION["userId"])  && isset($_SESSION["userName"])){
                    echo "<div class ='text-center'><a class ='text-white text-center' href ='includes/logout.inc.php' style='text-decoration:none;'>
                    <i class='fa fa-fw fa-sign-out'></i>Logout</a></div>";
                }
                else{
                    echo "<div class ='text-center'><a class='btn-sm btn-primary btn-lg' href='login.php' role='button'><i class='fa fa-sign-in' aria-hidden='true'></i> Donor Login</a></div>
                        ";
                }
